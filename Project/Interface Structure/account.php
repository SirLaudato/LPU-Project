            ...
            <div id="tab-account" class="tab active">
                <form action="save_account.php" method="POST">
                    ...
                    <div class="input-field">
                        ...
                        <div class="form-row">
                            <div>
                                <input type="text" id="first_name" name="first_name" required placeholder="Phone Number">
                            </div>
                            <div>
                                <input type="text" id="last_name" name="last_name" required placeholder="Email">
                            </div>
                        </div>
                    </div>
                    <div class="input-field">
                ...
                <form action="save_account.php" method="POST">
                    ...
                    <div class="input-field">
                        <h>Address</h>
                        <div class="widefield">
                            <input type="text" id="first_name" name="first_name" required placeholder="Address">
                        </div>
                        <div class="form-row">
                            <div>
                                <input type="text" id="first_name" name="first_name" required placeholder="Postal Code">
                            </div>
                            <div>
                                <input type="text" id="last_name" name="last_name" required placeholder="City">
                            </div>
                        </div>
                        <div class="form-row">
                            <div>
                                <input type="text" id="first_name" name="first_name" required placeholder="Province">
                            </div>
                            <div>
                                <input type="text" id="last_name" name="last_name" required placeholder="Country">
                            </div>
                        </div>
                    </div>
                    <button type="submit">Save</button>
            ...
            <button type="submit">Save</button>
                ...
                <form>
                    <div class="input-field">
                        ...
                        <div class="form-row">
                            <p>We care about your integrity, and continuously work toward making your Elektron experience as safe and secure as possible. Read the Elektron Privacy Policy to learn more about how we use and store personal data.</p>
                        </div>
                ...
                <div class="input-field">
                    ...
                    <div class="form-row">
                        <p>We care about your integrity, and continuosly work toward making your
                            Elektron experience as safe and secure as possible. Read the Elektron Privacy Policy
                ...
                <div id="tab-registered-products" class="tab">
                    ...
                    <p>You can also contact the Elektron customer support team. For the fastest help however, we recommend looking through appropriate product manuals, FAQ sections, or checking the Elektronauts user forum for answers.
    ...
    <div class="user-info">
        ...
        <div class="guide">
            <div class="guide-info">
                ...
                <p>You can also contact the Elektron customer support team. For the fastest help however, we recommend looking through appropriate product manuals, FAQ sections, or checking the Elektronauts user forum for answers.</p>
                <button class="con-shopping">Support & Downloads</button>
                <button class="con-shopping">General FAQs</button>
                <button class="con-shopping">Elektronauts User Forum</button>
            </div>
